...
#> Daily simulations ■■■■■■■■■                         28% | ETA: 17s
#> Daily simulations ■■■■■■■■■■                        30% | ETA: 16s
#> Daily simulations ■■■■■■■■■■■                       32% | ETA: 15s
#> Daily simulations ■■■■■■■■■■■                       34% | ETA: 14s
#> Daily simulations ■■■■■■■■■■■■                      37% | ETA: 13s
#> Daily simulations ■■■■■■■■■■■■                      38% | ETA: 12s
#> Daily simulations ■■■■■■■■■■■■■                     40% | ETA: 12s
#> Daily simulations ■■■■■■■■■■■■■■                    42% | ETA: 11s
#> Daily simulations ■■■■■■■■■■■■■■                    44% | ETA: 10s
#> Daily simulations ■■■■■■■■■■■■■■■                   47% | ETA: 10s
#> Daily simulations ■■■■■■■■■■■■■■■                   48% | ETA:  9s
#> Daily simulations ■■■■■■■■■■■■■■■■                  50% | ETA:  9s
...
#> • Aquifer balance content (mm): 23.88 fluxes (mm): 23.88
#> • Aquifer fluxes (mm) Drainage input: 129.61 Exfiltration: 105.72 Capillary
#> rise: 0.02 Negative aquifer correction: 0 Deep loss: 0
#> • Watershed balance content (mm): -18.87 fluxes (mm): -18.87
#> • Watershed fluxes (mm) Precipitation: 154.74 Surface export: 105.72
#> Evapotransp.: 67.9 Negative aquifer correction: 0 Deep loss: 0
#> 
#> ── FINAL BALANCE CHECK ──
#> 
#> • Final channel sum (m3): 0
#> • Final outlet sum (m3): 69814
#> • Final watershed export sum (m3): 69814
...
#>     Infiltration (mm) 137.52  Saturation excess (mm) 0
#>     Deep drainage (mm) 129.74  Capillarity rise (mm) 0.02
#>     Soil evaporation (mm) 3.45  Plant transpiration (mm) 47.76
#>     Interflow balance (mm) 0
#>   Aquifer water balance components:
#>     Deep drainage (mm) 129.61  Capillarity rise (mm) 0.02
#>     Exfiltration (mm) 105.72  Deep aquifer loss (mm) 0
#>     Negative aquifer correction (mm) 0
#>   Watershed water balance components:
#>     Precipitation (mm) 154.74
#>     Interception (mm) 17.47  Soil evaporation (mm) 3.4
#>     Plant transpiration (mm) 47.04
#>     Subsurface flow balance (mm) 0
#>     Groundwater flow balance (mm) 0
#>     Export runoff (mm) 105.72
...
#> ── WHOLE-WATERSHED SIMULATION ──
#> 
#> Daily simulations ■■■■■■■■■                         26% | ETA:  3s
#> Daily simulations ■■■■■■■■■                         27% | ETA:  3s
#> Daily simulations ■■■■■■■■■■                        29% | ETA:  3s
#> Daily simulations ■■■■■■■■■■■                       33% | ETA:  3s
#> Daily simulations ■■■■■■■■■■■■                      38% | ETA:  3s
#> Daily simulations ■■■■■■■■■■■■■■                    42% | ETA:  3s
#> Daily simulations ■■■■■■■■■■■■■■■                   47% | ETA:  2s
#> Daily simulations ■■■■■■■■■■■■■■■■■                 52% | ETA:  2s
#> Daily simulations ■■■■■■■■■■■■■■■■■■                57% | ETA:  2s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■               61% | ETA:  2s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■             66% | ETA:  2s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■            70% | ETA:  1s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■■■          76% | ETA:  1s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■■■■         79% | ETA:  1s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■■■■■        83% | ETA:  1s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■■■■■■       88% | ETA:  1s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■     93% | ETA:  0s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■    98% | ETA:  0s
#> Daily simulations ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■  100% | ETA:  0s
#> • Snowpack balance content (mm): 0 fluxes (mm): 0
#> • Soil balance content (mm): -42.94 fluxes (mm): -42.94
#> • Aquifer balance content (mm): 24.02 fluxes (mm): 24.02
#> • Aquifer fluxes (mm) Drainage input: 136.53 Exfiltration: 112.49 Capillary
#> rise: 0.02 Negative aquifer correction: 0.01 Deep loss: 0
#> • Watershed balance content (mm): -18.27 fluxes (mm): -18.27
#> • Watershed fluxes (mm) Precipitation: 154.74 Surface export: 112.49
#> Evapotransp.: 60.53 Negative aquifer correction: 0.01 Deep loss: 0
#> 
#> ── FINAL BALANCE CHECK ──
#> 
#> • Final channel sum (m3): 0
#> • Final outlet sum (m3): 74284
#> • Final watershed export sum (m3): 74284
# }
```
