.spwbspatial<-function(y, SpParams, meteo, control = defaultControl(), dates = NULL,  summaryFunction=NULL, args=NULL) {
...
spwbpoints<-function(y, SpParams, meteo, control = defaultControl(), dates = NULL, summaryFunction=NULL, args=NULL) {
  ...
  l = .spwbspatial(y=y, SpParams = SpParams, meteo = meteo, control = control, dates = dates, summaryFunction = summaryFunction, args = args)
