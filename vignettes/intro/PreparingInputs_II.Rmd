...
scchh <- terra::vect(paste0(dataset_path, "Hydrography/data-raw/Spain/CuencasMedNorte_Pfafs/M_cuencas_rios_Med_Norte.shp"))
...
dataset_path <- "~/OneDrive/EMF_datasets/"
counties <- terra::vect(paste0(dataset_path, "PoliticalBoundaries/data-raw/Catalunya/Comarques/comarques.shp"))
ggplot()+
...
```{r}
lcm <- terra::rast(paste0(dataset_path,"LandCover/data-raw/Catalunya/cobertes-sol-v1r0-2018.tif"))
lcm
```
...
```{r}
forest_map <- terra::vect(paste0(dataset_path,"ForestMaps/Spain/MFE25/data-raw/mfe_catalunia/MFE_51_class.gpkg"))
forest_map
```
...
```{r}
veg_map <- terra::vect(paste0(dataset_path,"ForestMaps/Catalunya/data-raw/Habitats_v2/Habitats_interes_com.shp"))
veg_map
```
...
```{r}
file_crop_map <- paste0(dataset_path,"Agriculture/data-raw/Catalunya/Cultius_DUN2018/Cultius_DUN2018.shp")
...
```{r}
crop_lookup_table <- readxl::read_xlsx(paste0(dataset_path, "Agriculture/data-raw/Catalunya/Kc_CAT_MOD.xlsx"))
...
```{r}
rivers <-terra::vect(paste0(dataset_path, "Hydrography/data-raw/Catalunya/Rius/Rius_CARACT.shp"))
```
