...
```{r, warning=FALSE}
dates <- seq(as.Date("2001-01-01"), as.Date("2001-01-05"), by="day")
res_ws5 <- spwb_land(r, sf_init,
                    SpParamsMED, examplemeteo, dates = dates,
