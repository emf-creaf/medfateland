...
```{r}
y_6 <- check_soils(y_5, fill_missing = TRUE)
```
...
```{r}
z <- initialize_landscape(y_7, SpParamsMED, defaultControl(),
                          progress = FALSE)
```
