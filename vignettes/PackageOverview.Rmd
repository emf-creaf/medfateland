...
Importantly, the three functions allow simulating *lateral water transfer processes*, for which two alternative sub-models are possible. A first sub-model, similar to TETIS (Francés et al. 2007) is offered by default, which includes three lateral water flows that are solved in simple way:
