...
For simulations over an incomplete or complete grid, a column is required in the **sf** object to specify neighborhood between adjacent cells. Documentation of the variables that need to be represented are given on the help pages of each simulation functions. The package also includes point and grid data sets to run examples. 
