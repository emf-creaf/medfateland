...
g2 <- plot_summary(res_L10$sf, "DeepDrainage", date = "2001-01-01", r = r, limits = c(0, 100))+labs(title = "R_local x 5")
g3 <- plot_summary(res_I10$sf, "DeepDrainage", date = "2001-01-01", r = r, limits = c(0, 100))+labs(title = "R_inter x 5")
g4 <- plot_summary(res_B10$sf, "DeepDrainage", date = "2001-01-01", r = r, limits = c(0, 100))+labs(title = "R_base x 5")
...
g2 <- plot_summary(res_L10$sf, "InterflowOutput", date = "2001-03-01", r = r, limits = c(0, 160))+labs(title = "R_local x 5")
g3 <- plot_summary(res_I10$sf, "InterflowOutput", date = "2001-03-01", r = r, limits = c(0, 160))+labs(title = "R_inter x 5")
g4 <- plot_summary(res_B10$sf, "InterflowOutput", date = "2001-03-01", r = r, limits = c(0, 160))+labs(title = "R_base x 5")
cowplot::plot_grid(g1, g2, g3, g4 , ncol = 1, nrow = 4)
```
...
g2 <- plot_summary(res_L10$sf, "BaseflowOutput", date = "2001-03-01", r = r, limits = c(0, 180))+labs(title = "R_local x 5")
g3 <- plot_summary(res_I10$sf, "BaseflowOutput", date = "2001-03-01", r = r, limits = c(0, 180))+labs(title = "R_inter x 5")
g4 <- plot_summary(res_B10$sf, "BaseflowOutput", date = "2001-03-01", r = r, limits = c(0, 180))+labs(title = "R_base x 5")
cowplot::plot_grid(g1, g2, g3, g4 , ncol = 1, nrow = 4)
```