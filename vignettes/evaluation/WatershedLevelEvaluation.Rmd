...
for(r in 1:nrow(df)) {
  df$before[[r]] <- yaml::read_yaml(file.path(evalDIR, "data", "output", df$version[r], df$model[r], df$watershed[r], "uncalibrated.yaml"))
  df$after[[r]] <- yaml::read_yaml(file.path(evalDIR, "data", "output", df$version[r], df$model[r], df$watershed[r], "calibrated.yaml"))
  df$Q_daily[[r]] <- read.csv2(file.path(evalDIR, "data", "output", df$version[r], df$model[r], df$watershed[r], "Q_daily.csv"))
  df$Q_monthly[[r]] <- read.csv2(file.path(evalDIR, "data", "output", df$version[r], df$model[r], df$watershed[r], "Q_monthly.csv"))
}
```
