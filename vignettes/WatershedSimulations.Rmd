...
## Simulation of watershed function and dynamics
...
res_ws <- spwb_land(r, example_watershed,
...
If we launch the simulations again (omiting progress information):
...
```{r}
res_ws <- fordyn_land(r, example_watershed[1:10, ],
