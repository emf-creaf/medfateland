...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(spwbgridDay(lct, xList, soilList, waterO, queenNeigh, waterQ, date, tminVec, tmaxVec, rhminVec, rhmaxVec, precVec, radVec, wsVec, latitude, elevation, slope, aspect, patchsize));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_medfateland_spwbgridDay", (DL_FUNC) &_medfateland_spwbgridDay, 19},
    {NULL, NULL, 0}
};
